...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), HumbleDesk diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare HumbleDesk a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a HumbleDesk su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a HumbleDesk su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a HumbleDesk de impreare su servìtziu 'Atzessibilidade'."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep HumbleDesk background service", "Mantene su servìtziu de HumbleDesk in s'isfundu"),
        ...
        ("Show RustDesk", "Mustra HumbleDesk"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a HumbleDesk sos permissos de 'Monitoràgiu insertada'."),
        ...
        ("verify_rustdesk_password_tip", "Cunfirma sa crae de HumbleDesk"),
        ...
        ("Exit", "Essi dae HumbleDesk"),
        ("Open", "Aberi HumbleDesk"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare HumbleDesk e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualiza HumbleDesk Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de HumbleDesk comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae HumbleDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana HumbleDesk est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de HumbleDesk"),
        ...
        ("About RustDesk", "Informatziones subra de HumbleDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualiza su cliente HumbleDesk remotu a sa versione {} o prus noa!"),
