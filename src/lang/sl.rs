...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, HumbleDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ...
        ("Language", "Jezik"),
        ("Keep HumbleDesk background service", "Ohrani RustDeskovo storitev v ozadju"),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za HumbleDesk"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite HumbleDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo HumbleDesk"),
        ...
        ("floating_window_tip", "Pomaga pri HumbleDesk storitvi v ozadju"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite HumbleDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
