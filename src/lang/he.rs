...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "בגלל UAC, HumbleDesk לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את HumbleDesk במערכת."),
        ...
        ("android_input_permission_tip2", "אנא עבור לדף הגדרות המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [HumbleDesk Input]."),
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep HumbleDesk background service", "השאר את שירות הרקע של HumbleDesk פעיל"),
        ("Ignore Battery Optimizations", "התעלם מאופטימיזציות סוללה"),
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום HumbleDesk , מצא והיכנס ל[סוללה], ובטל את הסימון מ-[לא מוגבל]"),
        ...
        ("Show RustDesk", "הצג את HumbleDesk"),
        ("This PC", "מחשב זה"),
        ("or", "או"),
        ...
        ("still_click_uac_tip", "עדיין נדרש מהמשתמש המרוחק לאשר את חלון ה-UAC של HumbleDesk"),
        ...
        ("verify_rustdesk_password_tip", "אמת סיסמת HumbleDesk"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "אנא שדרג את HumbleDesk Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("About RustDesk", "אודות HumbleDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "אנא שדרג את לקוח HumbleDesk לגרסה {} או חדשה יותר בצד המרוחק!"),
