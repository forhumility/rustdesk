...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Karena UAC, HumbleDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal HumbleDesk ke sistem."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd HumbleDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ...
        ("Language", "Bahasa"),
        ("Keep HumbleDesk background service", "Pertahankan HumbleDesk berjalan pada service background"),
        ...
        ("Show RustDesk", "Tampilkan HumbleDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada HumbleDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada HumbleDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC HumbleDesk yang sedang berjalan"),
        ...
        ("verify_rustdesk_password_tip", "Verifikasi Kata Sandi HumbleDesk"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Silahkan perbarui HumbleDesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah HumbleDesk berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh HumbleDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela HumbleDesk sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service HumbleDesk agar tetap aktif"),
        ...
        ("About RustDesk", "Tentang HumbleDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Silahkan perbarui aplikasi HumbleDesk ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
