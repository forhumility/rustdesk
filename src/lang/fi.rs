...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään HumbleDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa HumbleDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi RustDeskin järjestelmään."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten HumbleDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli HumbleDesk ohjelman käyttö."),
        ...
        ("Language", "Kieli"),
        ("Keep HumbleDesk background service", "Pidä RustDeskin taustapalvelu käynnissä"),
        ...
        ("Show RustDesk", "Näytä HumbleDesk"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista HumbleDesk salasanasi kirjautumista varten"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä HumbleDesk Server Pro versioon {} jatkaaksesi."),
