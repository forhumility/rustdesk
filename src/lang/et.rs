...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa HumbleDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et HumbleDesk oma süsteemi paigaldada."),
        ...
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [HumbleDesk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep HumbleDesk background service", "Säilita RustDeski taustateenus"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda HumbleDesk Server Pro versioonile {} või uuem!"),
