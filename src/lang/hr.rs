...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na HumbleDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a HumbleDesk ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate HumbleDesk na sustav."),
        ...
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [HumbleDesk Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep HumbleDesk background service", "Zadrži HumbleDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje HumbleDesk aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show RustDesk", "Prikaži HumbleDesk"),
        ...
        ("verify_rustdesk_password_tip", "Provjera lozinke za HumbleDesk"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ažurirajte HumbleDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti HumbleDesk da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće HumbleDesk"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo ažurirajte HumbleDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
