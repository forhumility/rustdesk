...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), HumbleDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare HumbleDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a HumbleDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a HumbleDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a HumbleDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [HumbleDesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep HumbleDesk background service", "Mantieni il servizio di HumbleDesk in background"),
        ...
        ("Show RustDesk", "Visualizza HumbleDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a HumbleDesk 'Monitoraggio input'."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password HumbleDesk"),
        ...
        ("Exit", "Esci da HumbleDesk"),
        ("Open", "Apri HumbleDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare HumbleDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna HumbleDesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di HumbleDesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da HumbleDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra HumbleDesk è aperta"),
        ...
        ("About RustDesk", "Info su HumbleDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client HumbleDesk remoto alla versione {} o successiva!"),
